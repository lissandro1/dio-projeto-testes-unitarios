package dio.diotestesunitarios.service;
...
import dio.diotestesunitarios.exception.BeerAlreadyRegisteredException;
import dio.diotestesunitarios.exception.BeerNotFoundException;
import dio.diotestesunitarios.exception.BeerStockExceededException;
import dio.diotestesunitarios.mapper.BeerMapper;
import dio.diotestesunitarios.repository.BeerRepository;
...
public class BeerService {
	...
	/*	public BeerDTO decrement(Long id, int quantityToDecrement)
			...
			if (quantityAfterDecrement <= beerToDecrementStock.getQuantity()) {
